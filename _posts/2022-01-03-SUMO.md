...
In a recent [paper](https://www.sciencedirect.com/science/article/pii/S2666248523000069), we have explored the use of surrogate models (SUMO) for the optimal design of an important phase in Li-ion battery manufacturing. Our data come from simulations that have been shown to faithfully reproduce real experimental conditions. However:
